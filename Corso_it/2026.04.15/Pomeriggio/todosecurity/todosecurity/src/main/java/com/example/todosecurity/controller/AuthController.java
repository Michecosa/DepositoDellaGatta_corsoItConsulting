...
import com.example.todosecurity.dto.AuthRequest;
import com.example.todosecurity.dto.AuthResponse;
import com.example.todosecurity.dto.RegisterRequest;
import com.example.todosecurity.model.Utente;
import com.example.todosecurity.repository.UtenteRepository;
import com.example.todosecurity.service.CustomUserDetailsService;
import com.example.todosecurity.service.JwtService;
...
public class AuthController {
  ...
  public ResponseEntity<?> login(@RequestBody AuthRequest request) {
    ...
    try {
      ...
      // In caso di credenziali errate o utente non trovato, restituiamo 401 invece di
      // 403
